 ...
 * BILD Interface
 */
interface IBILD extends IBlockchainState {
    action: TypeAction;
    isGovernor: boolean;
}
/**
 ...
 */
class BILD extends Component<{}, IBILD> {
    /**
     * @ignore
     */
    ...
    public render() {
        ...
        return (
            <div className="BILD">
             <Navbar />
                <div className="BILD__grid">
                    <div className="BILD__main">
                        <ul>
                            <li
                                className="BILD-Input__title BILD-Input__title--big"
...
function RegisterTokensHook(props: { mixrContract: IMIXRContractType, userAccount: string }) {
    ...
    function updateRegisteredTokens() {
        ...
        mixrContract.getRegisteredTokens().then((tokens: [[string], number]) => {
            ...
            const tokenElements = tokenMap.map(
                (token) => <li className="BILD-Input__title BILD-Input__title--padding" key={token}>{token}</li>,
            );
    ...
    return (
        <React.Fragment>
            <p className="BILD-Input__title BILD-Input__title--big">ADD ERC20 STABLECOIN</p>
            <form onSubmit={handleSubmit}>
                <div className="BILD__inputs-grid">

                    <div>
                        <p className="BILD-Input__title BILD-Input__title--padding">ADDRESS</p>
                        <input
                            className="BILD__input-approvals"
                            type="text"
                            placeholder="Address"
                            name="erc20Address"
                            value={erc20Address}
                    ...
                    <div>
                        <p className="BILD-Input__title BILD-Input__title--padding">NAME</p>
                        <input
                            className="BILD__input-approvals"
                            type="text"
                            placeholder="Name"
                    ...
                    <div>
                        <p className="BILD-Input__title BILD-Input__title--padding">DECIMALS</p>
                        <input
                            className="BILD__input-approvals"
                            type="number"
                    ...
                    <div />
                    <div />
                    <div className="BILD__button-grid">
                        <input className="BILD__button" type="submit" value="SUBMIT" />
                    </div>
                </div>
            </form>
            <p
                className="BILD-Input__title BILD-Input__title--big BILD-Input__title--padding"
            >
                TOKEN ADDRESSES
            </p>
            <ul id="tokensList" />
...
function SetTargetProportionHook(props: { mixrContract: IMIXRContractType, web3: IWeb3Type, userAccount: string }) {
            ...
            tokensProportions.map((token) => {
                return (
                    <li key={token.address}>
                        <p className="BILD-Input__title">{token.name}</p>
                        <br />
                        <input
                            name={token.address}
                            type="text"
                            ...
                            onChange={handleChange}
                            className="BILD__input-approvals--full-width"
                        />;
                    </li>
                );
            })
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="BILD__token-proportion-grid">
                <div />
                <div className="BILD__button-grid">
                    <input className="BILD__button" type="submit" value="SUBMIT" />
                </div>
...
function SetBaseFeeHook(props: { mixrContract: IMIXRContractType, web3: IWeb3Type, userAccount: string }) {
    ...
    return (
        <div>
            <p className="BILD-Input__title BILD-Input__title--big BILD-Input__title--padding">
                BASE FEE DEPOSIT
            </p>
            <form name="baseFeeDeposit" onSubmit={handleSubmit}>
                <div className="BILD__inputs-grid">
                    <div>
                        <p className="BILD-Input__title BILD-Input__title--padding">AMOUNT</p>
                        <input
                            type="text"
